...
static const char *frenchMessages[] = {
    ...
    "attention : l'url contient déjà des données, qui seront écrasées par les données de ce formulaire",
...
static const char upperMore[] = "©ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝÞßÿ";

static const char lowerMore[] = "©àáâãäåæçèéêëìíîïðñòóôõöøùúûüýþßÿ";

static const char letterMore[] =
   "©ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝÞ©àáâãäåæçèéêëìíîïðñòóôõöøùúûüýþßÿ";
static bool
