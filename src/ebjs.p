...
/* sourcefile=html.cpp */
void javaSetsTimeout(int n, const char *jsrc, JS::HandleObject to, eb_bool isInterval);
...
void establish_innerHTML(JS::HandleObject jv, const char *start, const char *end, eb_bool is_ta) ;
void jMyContext(void) ;
eb_bool javaParseExecute(JS::HandleObject obj, const char *str, const char *filename, int lineno) ;
eb_bool javaParseExecuteGlobal(const char *str, const char *filename, int lineno) ;
JSObject * domLink(const char *classname, const char *symname, const char *idname, const char *href, const char *href_url, const char *list, JS::HandleObject owner, int radiosel) ;

/* sourcefile=jsloc.cpp */
const char * stringize(jsval v) ;
void initLocationClass(void) ;
void establish_property_string(JS::HandleObject jv, const char *name, const char *value, eb_bool readonly) ;
void establish_property_number(JS::HandleObject jv, const char *name, int value, eb_bool readonly) ;
void establish_property_bool(JS::HandleObject jv, const char *name, eb_bool value, eb_bool readonly) ;
JSObject * establish_property_array(JS::HandleObject jv, const char *name) ;
void establish_property_object(JS::HandleObject parent, const char *name, JS::HandleObject child) ;
void establish_property_url(JS::HandleObject jv, const char *name, const char *url, eb_bool readonly) ;
