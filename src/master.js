...
This file is converted into a C string and compiled and run at startup.
The per window functions are in compartment.js.
The functions herein can be compiled once and then used by every window thereafter.
I wish I could say the same for classes.
As of MOZ 62, there seems to be a problem with a class in one compartment
instantiating an object in another.
My workaround is to copy the classes in every compartment,
and then point to their prototypes in the master window,
the prototypes carrying most of the functions for that class.
...
mw0.URL.prototype.dom$class = "URL";
...
mw0.Node = function(){}; mw0.Node.prototype.dom$class = "Node";
...
mw0.DocType = function(){ this.nodeType = 10, this.nodeName = "DOCTYPE";}; mw0.DocType.prototype.dom$class = "DocType";
mw0.DocumentType = function(){}; mw0.DocumentType.prototype.dom$class = "DocumentType";
mw0.CharacterData = function(){}; mw0.CharacterData.prototype.dom$class = "CharacterData";
mw0.Head = function(){}; mw0.Head.prototype.dom$class = "Head";
mw0.Meta = function(){}; mw0.Meta.prototype.dom$class = "Meta";
mw0.Title = function(){}; mw0.Title.prototype.dom$class = "Title";
...
mw0.Link = function(){}; mw0.Link.prototype.dom$class = "Link";
...
mw0.Base = function(){}; mw0.Base.prototype.dom$class = "Base";
mw0.Form = function(){ this.elements = []; }; mw0.Form.prototype.dom$class = "Form";
...
mw0.Validity = function(){}; mw0.Validity.prototype.dom$class = "Validity";
/*********************************************************************
...
mw0.Image = function(){}; mw0.Image.prototype.dom$class = "Image";
mw0.Frame = function(){}; mw0.Frame.prototype.dom$class = "Frame";
mw0.Anchor = function(){}; mw0.Anchor.prototype.dom$class = "Anchor";
mw0.HTMLAnchorElement = function(){}; mw0.HTMLAnchorElement.prototype.dom$class = "HTMLAnchorElement";
mw0.HTMLLinkElement = function(){}; mw0.HTMLLinkElement.prototype.dom$class = "HTMLLinkElement";
mw0.HTMLAreaElement = function(){}; mw0.HTMLAreaElement.prototype.dom$class = "HTMLAreaElement";
mw0.Lister = function(){}; mw0.Lister.prototype.dom$class = "Lister";
mw0.Listitem = function(){}; mw0.Listitem.prototype.dom$class = "Listitem";
mw0.tBody = function(){ this.rows = []; }; mw0.tBody.prototype.dom$class = "tBody";
mw0.tHead = function(){ this.rows = []; }; mw0.tHead.prototype.dom$class = "tHead";
mw0.tFoot = function(){ this.rows = []; }; mw0.tFoot.prototype.dom$class = "tFoot";
mw0.tCap = function(){}; mw0.tCap.prototype.dom$class = "tCap";
mw0.Table = function(){ this.rows = []; this.tBodies = []; }; mw0.Table.prototype.dom$class = "Table";
mw0.Div = function(){}; mw0.Div.prototype.dom$class = "Div";
...
mw0.Label = function(){}; mw0.Label.prototype.dom$class = "Label";
...
mw0.HtmlObj = function(){}; mw0.HtmlObj.prototype.dom$class = "HtmlObj";
mw0.Area = function(){}; mw0.Area.prototype.dom$class = "Area";
mw0.Span = function(){}; mw0.Span.prototype.dom$class = "Span";
mw0.Span.prototype.doScroll = eb$voidfunction;
mw0.tRow = function(){ this.cells = []; }; mw0.tRow.prototype.dom$class = "tRow";
mw0.Cell = function(){}; mw0.Cell.prototype.dom$class = "Cell";
mw0.P = function(){}; mw0.P.prototype.dom$class = "P";
mw0.Header = function(){}; mw0.Header.prototype.dom$class = "Header";
mw0.Footer = function(){}; mw0.Footer.prototype.dom$class = "Footer";
mw0.Script = function(){}; mw0.Script.prototype.dom$class = "Script";
mw0.Script.prototype.type = "";
mw0.Script.prototype.text = "";
mw0.HTMLScriptElement = mw0.Script; // alias for Script, I guess
mw0.Timer = function(){this.nodeName = "TIMER";}; mw0.Timer.prototype.dom$class = "Timer";
mw0.Audio = function(){}; mw0.Audio.prototype.dom$class = "Audio";
...
mw0.Canvas = function() {}; mw0.Canvas.prototype.dom$class = "Canvas";
...
mw0.AudioContext.prototype.dom$class = "AudioContext";

// Document class, I don't know what to make of this,
// but my stubs for frames needs it.
mw0.Document = function(){}; mw0.Document.prototype.dom$class = "Document";

mw0.CSSStyleSheet = function() { this.cssRules = []; }; mw0.CSSStyleSheet.prototype.dom$class = "CSSStyleSheet";
...
mw0.Comment.prototype.dom$class = "Comment";
...
mw0.Option.prototype.dom$class = "Option";
...
mw0.Attr = function(){ this.specified = false; this.owner = null; this.name = ""; }; mw0.Attr.prototype.dom$class = "Attr";
...
mw0.NamedNodeMap = function() { this.length = 0; }; mw0.NamedNodeMap.prototype.dom$class = "NamedNodeMap";
...
mw0.Event.prototype.dom$class = "Event";
...
if(newobj.nodeType == 11) return mw0.appendFragment(this, newobj);
this.appendChildNative(newobj);
if(newobj.dom$class == "tRow") mw0.rowReindex(this);
...
if(!this.removeChildNative(item))
return null;
if(item.dom$class == "tRow") mw0.rowReindex(this);
...
mw0.MutationObserver.prototype.dom$class = "MutationObserver";
...
mw0.MutationRecord.prototype.dom$class = "MutationRecord";
