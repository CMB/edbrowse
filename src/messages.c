...
static const char *polishMessages[] = {
	...
	"ftp: błędny URL",
	"ftp: błąd użycia",
	"ftp: nieprawidłowy login lub hasło",
	...
	"Nie można zakończyć sekwencji pop3 login/hasło <%s>",
