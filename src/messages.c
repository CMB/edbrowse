...
static const char *germanMessages[] = {
	...
	".ebrc enthält keinen Block subjfilter {...}",
	...
	"Es wurde ein separates Fenster in Puffer %d angelegt\n",
	" viele",
	" empfohlen",
	"]",
	...
	"Löschen",
	"IP gelöscht",
	"die Option -p deaktiviert dieses Feature",
	...
	"Entschuldigung, Aktualisierungen im Textfeld noch nicht implementiert",
	"keine Fehler",
	...
	"Datei hat keine Endung, nutzen Sie mt.xxx, um eine eigene Endung anzugeben",
	...
	"ftp konnte sich nicht zum entfernten Rechner verbinden (Zeitüberschreitung)",
	"FTP-Übertragung fehlgeschlagen",
	"FTP-Übertragung fehlgeschlagen (Zeitüberschreitung)",
	"Aufbau...",
	"stop",
	"ftp fehlerhafte url",
	"keine Anhänge",
	...
	"kann * ? oder [] nicht vor dem letzten / expandieren",
	"%s ist kein existierendes Verzeichnis",
	"Shell-Muster ist zu lang",
	"Ich kann leider Dateinamen mit \\ nicht expandieren",
	"fehlerhaftes [] Muster",
	"Fehler beim Kompilieren des Shell-Musters %s",
	...
	"%s tritt inmitten eines Links auf",
	"%s enthält HTML-Tags",
	...
	"Konnte Konfigurationsdatei nicht schreiben, Ihre Einstellungen gehen eventuell verloren!",
	...
	".ebrc: Zeile %d, Attribut %s kann nicht außerhalb eines MIME-Descriptors gesetzt werden",
	...
	".ebrc: Zeile %d, Attribut %s kann nicht innerhalb eines MIME-Deskriptors gesetzt werden",
	...
	".ebrc: Email-Papierkorb %s ist keine reguläre Datei",
	...
	".ebrc: Zeile %d, kann hier keine Funktion, Mail-MIME-Deskriptor oder Filterblock innerhalb von %s beginnen",
	".ebrc: Anweisung in Zeile %d muss innerhalb einer Funktion auftreten",
	"zu viele Emailkonten in .edbrc, maximal %d",
	"zu viele MIME-Typen in .ebrc, maximal %d",
	...
	".ebrc: Email- oder MIME-Block nicht vor dem Dateiende beendet",
	...
	"Hostname:Port ist zu lang",
	"Protokoll: ist zu lang",
